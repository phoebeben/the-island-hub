...
Island.create!(name: "Nohea Tropic", location: "Philippines", price: 35, available: true, description: "The best island to choose if you're looking for great scenery and tropical weather! Perfect for any amount of guests, but beware of the #{Faker::Animal}", user_id: user.id)
